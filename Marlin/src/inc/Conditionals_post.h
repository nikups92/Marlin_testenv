...
#if HAS_TEMPERATURE && ANY(HAS_MARLINUI_MENU, HAS_DWIN_E3V2, HAS_DGUS_LCD_CLASSIC, DWIN_CREALITY_LCD)
 ...
 */
  ...
  #if ANY(HAS_MARLINUI_MENU, EXTENSIBLE_UI, DWIN_LCD_PROUI, DWIN_CREALITY_LCD) || BOTH(EMERGENCY_PARSER, HOST_PROMPT_SUPPORT)
...
#if EITHER(SCROLL_LONG_FILENAMES, HAS_DWIN_E3V2) || ENABLED(DWIN_CREALITY_LCD)
